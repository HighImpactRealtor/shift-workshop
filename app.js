...
(function () {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    const productionGoal = form.production_goal ? form.production_goal.value.trim() : '';
    const stuck = form.stuck ? form.stuck.value.trim() : '';
    const questions = form.questions ? form.questions.value.trim() : '';
